    ...
    <div className="hidden sm:flex flex-col items-center xl:items-start xl:w-[340] p-2 fixed h-full">
      ...
      <button className="hidden xl:inline ml-auto bg-[#1d9bf0] text-white rounded-full
       ...
       xl:ml-auto xl:-mr-5">
           ...
           <img src="https://lh3.googlusercontent.com/a/AATXAJwCsuneWAkKlHwMPxOmLNjFACEvbtN8QPwbUsZ-=s96-c" 
           alt="" 
           className="h-10 w-10 rounded-full xl:mr-2.5"/>
           <div className="hidden xl:inline leading-5">
               <h4 className="font-bold">firebase 9999</h4>
               <p className="text-[#6e767d]">@firebase9999</p>
           </div>
